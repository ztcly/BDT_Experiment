...
<div class="content-container wrap">
                            ...
                            <li>
                                <div class="navbar-login">
                                    ...
                                    <div class="btn-group margin-bottom-2x" role="group">
                                        <a href="profile"> <button type="button" class="btn btn-default"><i class="fa fa-user"></i> 管理</button></a>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12">
                <span class="page-title red"><h2>创建商店</h2></span>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
    ...
    <div class="container-fluid">
        <div class="block-content">
            <div class="form-group">
                ...
                <label for="shopnameinput">店铺名称</label>
                <input type="text" class="form-control" id="shopnameinput" placeholder="输入店铺名称" name="shopname">
                    <label for="exampleInputFile">上传店铺头像</label>
                    <input type="file" accept="image/*" id="exampleInputFile" name="file">
                    <p class="help-block">在这里上传店铺头像</p>
                    <button type="submit" class="btn btn-primary">创建商店</button>
                    <a href="goodindex"><button class="btn btn-default">取消</button></a>
