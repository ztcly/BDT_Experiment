...
<%@ page import="java.io.*,java.util.*,com.ztcly.shop.Service.ShopService,com.ztcly.shop.model.Good" %>
...
<div class="content-container wrap">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12">
                <span class="page-title red"><h2>管理商店</h2></span>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
            ...
            <div class="form-group">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">${shop.shopname} 在售商品</h3>
                    </div>
...
<%--                            表格正文--%>
                       <%-- <%
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:forEach items="${goodlist}" var="in">
                                    ...
                                    <c:out value="<th><button type=\"button\" class=\"btn btn-sm btn-info\" onclick=\"Delete('${in.id}')\">删除</button></th>" escapeXml="false"></c:out>
                                    <c:out value="</tr>" escapeXml="false"></c:out>
                              </c:forEach>
                            </c:otherwise>
                        </c:choose>
                ...
                <div class="form-group">
                    <form action="/creategood" method="post" enctype="multipart/form-data">
                        <label for="goodnameinput">新建商品</label>
                        <input type="text" class="form-control" id="goodnameinput" placeholder="输入商品名称" name="goodname">
                        <label for="exampleInputFile">上传商品图象</label>
                        <input type="file" accept="image/*" id="exampleInputFile" name="file">
                        <p class="help-block">在这里上传商品图象</p>
